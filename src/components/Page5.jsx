...
const Page5 = () => {
  return (
    <motion.div
      ...
      className="w-full h-screen flex items-center justify-center border-b-[0.1px]"
    >
      <div className="h-full w-[63%] flex justify-end items-center py-10 pl-10 ">
        <div className="left-text w-[37%] flex flex-col items-start gap-8 ">
          <h1 className="text-[2.3vw] leading-none ">
            Our studio represents today's modern world: progressive, inclusive,
            and socially engaged.
          </h1>
          <p className="text-sm mt-26">
